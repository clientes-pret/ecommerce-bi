#!/usr/bin/env python3
"""
semaforo_ml.py — Semáforo de publicaciones ML Pret a Home
...
def main():
    print(f"\n{'═'*56}")
    print(f"  SEMÁFORO ML PRET A HOME")
    ...
    out_path = out_dir / f"semaforo_ml_pret_{fecha}.xlsx"
    log("Generando Excel...")
